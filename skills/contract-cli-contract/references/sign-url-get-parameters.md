# contract sign-url get Parameters

本页专用于 `contract-cli contract sign-url get`。

- 接口：`GET /open-apis/contract/v1/contracts/{contract_id}/sign_url`
- 身份：仅 `app`
- 请求体：官方接口不要求 JSON 请求体
- 官方 OpenAPI：[开平接口获取签署链接](https://docs.qfei.cn/464620072e0.md)
...
| 参数 | 请求位置 | 类型 | 必填性 | 说明 |
| --- | --- | --- | --- | --- |
| <contract-id> | $path.contract_id | string | 必填（服务端） | — |
...
- 官方规格路径：`GET /open-apis/contract/v1/contracts/{contract_id}/sign_url`
